...
var LabelsMonth = (_ref) => {
  ...
  return (0, import_jsx_runtime2.jsx)(import_react2.Fragment, {
    children: [...data].map((item, idx) => {
      return (0, import_jsx_runtime2.jsx)("text", {
        "data-size": rectSize,
...
function Legend(_ref) {
  ...
  return (0, import_react4.useMemo)(() => (0, import_jsx_runtime4.jsx)(import_react4.Fragment, {
    children: Object.keys(panelColors || {}).map((num, key) => {
      ...
      return (0, import_jsx_runtime4.jsx)(Rect, _extends({}, rectProps));
    })
    ...
    children: gridNum > 0 && [...Array(gridNum)].map((_, idx) => {
      return (0, import_jsx_runtime5.jsx)("g", {
        ...
        children: [...Array(7)].map((_2, cidx) => {
          ...
          return (0, import_jsx_runtime5.jsx)(Rect, _extends({}, dayProps, {
            value: dataProps,
            "data-date": date,
...
function SVG(props) {
  ...
  return (0, import_jsx_runtime7.jsxs)("svg", _extends({
    ref: svgRef,
...
import "D:/Developments/Development Projects/Web Development/Front-end projects/React.js projects/other projects/Twinv-user-side/node_modules/@uiw/react-heat-map/esm/style/index.css";
...
function HeatMap(props) {
  ...
  return (0, import_jsx_runtime8.jsx)(SVG, _extends({
    className: cls
  }, others));
}
export {
